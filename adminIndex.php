                    ...
                    <div class="card-body">
                        ...
                        <div styl="max-width: 400px; margin: 0 auto">
                            <div class="btn-group dropend dropdown mb-3">
                                <button class="btn btn-outline-dark " type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false"> 
                                    <b>ADMIN</b>
                                </button>
                            </div>
                        </div>     
                        ...
                        <a class="btn btn-primary" href="donationListAdmin.php">DONATION ACTIVITY</a><br><br>
                        <a class="btn btn-success" href="NewContact.php">New Contact</a>
                    </div>
                </div>
            </div>
        </div>
