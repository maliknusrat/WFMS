...
<head>
    ...
    <title>FOOD COLECTOR TEAM</title>
...
<body>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2 class="text-center mt-3">FOOD COLECTOR TEAM</h2>
        </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <a class="btn btn-warning position-relative" href="newDonationList.php">
                        ...
                        <a class="btn btn-secondary" href="oldDonationList.php">OLD REQUEST</a>
                    </div>
                </div>
            </div>
        </div>
