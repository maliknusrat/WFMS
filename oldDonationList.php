...
<?php
	...
	$result = $conn->query("SELECT * FROM demand WHERE stage>3 or (stage=3 and status!='unseen' and status!='seen') ORDER BY id DESC LIMIT $start, $limit");
...
<div class="bg">
    ...
    <div class="panel-heading">
            <h3 class="text-center mt-3">DONATION LIST</h3>
    </div>
    <div class="container">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination pagination-sm">
                                <li class="page-item <?php if($Previous == 0):?> disabled <?php endif; ?>">
                                    <a class="page-link" href="accountOfficerOldBudgetList.php?page=<?= $Previous; ?>" aria-label="Previous">
                                        <span class = "page-link" aria-hidden="true">&laquo;</span>
                                    </a>
                                </li>
                                <?php for($i = 1; $i<= $pages; $i++) : ?>
                                        <li class="page-item <?php if($i == $page):?> active <?php endif; ?>">
                                            <a class="page-link" href="accountOfficerOldBudgetList.php?page=<?= $i; ?>"> 
                                                <span class = "page-link"> <?= $i; ?> </span>
                                            </a>
                                        </li>
                                <?php endfor; ?>
                                <li class="page-item <?php if($Next == $pages+1):?> disabled <?php endif; ?>">
                                    <a class="page-link" href="accountOfficerOldBudgetList.php?page=<?= $Next; ?>" aria-label="Next">
                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="teamStatement.php?id=<?= $budget['id'];?>">   
