...
------------------------------------------*/
    public function userRegistration($data)
    {
        ...
        if ($result) {
            ...
            $mailHtml = "Please confirm your registration by clicking the button bellow : <br><a href='http://localhost/New/verification.php?verification_id=$verification_id'><input name='submit' class='btn btn-primary mt-4' type='submit' value='Verify your account'></a>";
    ...
    public function smtp_mailer($to, $subject, $msg){
        ...
        $mail->IsHTML(true);
        $mail->CharSet = 'UTF-8';
        $mail->Username = "wastefoodmanagement.just@gmail.com";
        $mail->Password = "hfkhmcmtnkvlukbx";
        $mail->SetFrom("wastefoodmanagement.just@gmail.com");
...
public function userLogin($data){
    ...
    if ($result) {
        ...
        session::set("loginmgs", "<div class='alert alert-success'><strong>Successfully login</strong></div>");
        if ($row['type']=='general') {
